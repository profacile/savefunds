...
/**
 * DTO pour la mise à jour partielle d'une analysis.
 * Seuls requestedAmount et status sont modifiables.
 * Une analysis TERMINEE ne peut plus être modifiée (validé côté service).
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Requête pour mettre à jour une analysis de prélèvement (mise à jour partielle)")
public class UpdateWithdrawalAnalysisRequest {
